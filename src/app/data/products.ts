...
export const products: ProductDetail[] = [
  // ═══════════════ AGRICULTURA ═══════════════
  {
    ...
    badge: 'Más vendido',
    description:
      'HiSoil Compost es una enmienda orgánica elaborada a partir de residuos agroindustriales seleccionados mediante un proceso controlado de compostaje aeróbico. Su alto contenido de materia orgánica estabilizada y actividad biológica contribuye a mejorar la fertilidad, la estructura y el funcionamiento del suelo de manera sostenible. Desarrollado para agricultura extensiva e intensiva, es una solución natural para incrementar la productividad, favorecer la salud del suelo y reducir la dependencia de fertilizantes de síntesis química.',
    composition: [
      'Materia orgánica 30%',
  ...
  },
  {
    ...
    description:
      'HiSoil Biofert es un biofertilizante líquido formulado con un consorcio de microorganismos benéficos y sustancias bioactivas, desarrollado para potenciar la actividad biológica del suelo y favorecer el crecimiento de los cultivos. Su formulación estimula los procesos biológicos naturales del suelo, promoviendo una mayor disponibilidad de nutrientes, un mejor desarrollo radicular y una mayor eficiencia en el aprovechamiento de los fertilizantes aplicados. Puede incorporarse fácilmente a programas de agricultura convencional, agricultura regenerativa y producción orgánica, mediante aplicaciones al suelo, fertirriego o pulverización foliar.',
    composition: [
  ...
  // ═══════════════ PAISAJISMO ═══════════════
  {
    ...
    usage: '5–20 L/m²',
    description:
      'HiSoil Compost es una enmienda orgánica premium elaborada a partir de residuos agroindustriales seleccionados mediante un proceso controlado de compostaje aeróbico. El resultado es un producto estable, homogéneo y biológicamente activo que mejora las propiedades físicas, químicas y biológicas del suelo. Su incorporación incrementa el contenido de materia orgánica, favorece la actividad microbiana y mejora la estructura del suelo, permitiendo una mayor infiltración y retención de agua. Además, aporta nutrientes de liberación gradual que promueven un crecimiento más equilibrado y sostenible de la vegetación. Es una solución ideal para jardines, parques, plazas, viveros, canteros ornamentales, arbolado urbano y proyectos de paisajismo que buscan mejorar la calidad del suelo de forma natural.',
    composition: [
      'Materia orgánica estabilizada',
  ...
  },
  {
    ...
    description:
      'HiSoil Outdoor es un sustrato profesional especialmente desarrollado para el cultivo de plantas de exterior en jardines, parques, canteros, macetas y proyectos de paisajismo. Su formulación combina materias primas de alta calidad que proporcionan un excelente equilibrio entre aireación, retención de humedad y estabilidad física. Su estructura favorece un rápido desarrollo radicular, permitiendo un mejor establecimiento de las plantas y un crecimiento más vigoroso durante todo el ciclo de cultivo. Además, mantiene sus propiedades físicas durante largos períodos, reduciendo la compactación y facilitando el mantenimiento de los espacios verdes. Es un producto ideal tanto para uso profesional como residencial, adaptándose a una amplia variedad de especies ornamentales y condiciones ambientales.',
