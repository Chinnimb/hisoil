      ...
      <div className="max-w-[1600px] mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-6">
            ...
            <h2 className="text-gray-900 mb-10">Información de contacto.</h2>
          ...
          {/* Right — coverage */}
          <div className="lg:col-span-6">
            <div className="bg-gray-50 border border-gray-200 rounded-sm p-8 h-full">
              <div className="text-xs font-mono text-gray-400 uppercase tracking-widest mb-2">Cobertura nacional</div>
              <div className="text-gray-900 font-semibold mb-1">Operamos en 12 provincias</div>
              ...
              {/* Map placeholder */}
              <div className="bg-gray-100 border border-gray-200 rounded-sm aspect-[16/9] flex flex-col items-center justify-center gap-2">
