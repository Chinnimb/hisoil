        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
              ...
              {infoItems.map((item) => (
                <div key={item.label} className="py-5 grid grid-cols-5 gap-4">
                  ...
                  <div className="col-span-3">
                    ...
                    {item.sub && (
                      <div className="text-gray-600 text-xs font-mono mt-0.5">{item.sub}</div>
                    )}
                  </div>
                </div>
              ))}
          ...
          <div className="lg:col-span-6">
            <div className="bg-paja border border-gray-300 rounded-sm p-8 h-full">
              ...
              <div className="text-oliva font-semibold mb-1">
                Operamos en 3 provincias · capacidad nacional
              </div>
