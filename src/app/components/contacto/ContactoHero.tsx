    ...
    <section className="relative bg-oliva py-16 md:py-24 lg:py-32 px-6 md:px-12 lg:px-20 overflow-hidden">
      ...
      <div className="relative z-10 w-full">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-white mb-6 leading-[1.05]">Hablemos de tu proyecto.</h1>

          <p className="text-white/70 text-lg leading-relaxed mb-10 max-w-xl mx-auto">
            Nuestro equipo está listo para ayudarte a encontrar la mejor solución para tu operación,
            cultivo o empresa.
          </p>
