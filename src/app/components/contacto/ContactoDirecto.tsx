const channels = [
  {
    ...
    description:
      'Respuesta inmediata en horario comercial. El canal más rápido para consultas urgentes.',
  ...
  },
  {
    ...
    value: '+54 9 11 4440-1919',
    description:
      'Atención telefónica de lunes a viernes de 8 a 18 hs. Para consultas que requieren explicación detallada.',
    cta: 'Llamar ahora',
    highlight: false,
    tag: null,
  },
  {
    ...
    description:
      'Para consultas formales, envío de documentación o solicitudes que requieren seguimiento escrito.',
    cta: 'Enviar correo',
    highlight: false,
    tag: null,
  },
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {channels.map((c) => (
            ...
            >
              ...
              <div
                className={`text-xs font-mono uppercase tracking-widest mb-1 ${c.highlight ? 'text-white/65' : 'text-gray-600'}`}
              >
                {c.label}
              </div>
              ...
              <p
                className={`text-sm leading-relaxed flex-1 mb-8 ${c.highlight ? 'text-white/70' : 'text-gray-700'}`}
              >
                {c.description}
              </p>
