export function FinalCTAContacto() {
  return (
          ...
          <div className="lg:col-span-7 bg-oliva p-12 md:p-16 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="inline-block border border-white/20 px-3 py-1 mb-8">
                <span className="text-white/40 text-xs font-mono uppercase tracking-widest">07 — ¿Listo para empezar?</span>
              </div>
              <h2 className="text-white mb-6">¿Listo para empezar?</h2>
              <p className="text-white/50 leading-relaxed text-lg mb-10 max-w-lg">
                [Texto — El primer paso es una consulta sin compromiso. Nuestro equipo técnico analiza tu situación y te presenta una solución a medida en menos de 48 horas hábiles.]
              </p>
