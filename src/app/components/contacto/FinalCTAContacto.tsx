            ...
            <div className="relative z-10">
              <div className="inline-block border border-white/20 px-3 py-1 mb-8">
                <span className="text-white/65 text-xs font-mono uppercase tracking-widest">
                  07 — ¿Listo para empezar?
                </span>
              </div>
              <h2 className="text-white mb-6">¿Listo para empezar?</h2>
              <p className="text-white/70 leading-relaxed text-lg mb-10 max-w-lg">
                [Texto — El primer paso es una consulta sin compromiso. Nuestro equipo técnico
                analiza tu situación y te presenta una solución a medida en menos de 48 horas
                hábiles.]
              </p>
