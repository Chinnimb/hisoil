        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-7">
            ...
            <p className="text-gray-700 mb-10 leading-relaxed">
              Completá el formulario y un asesor técnico se contacta con vos en menos de 24 horas
              hábiles.
            </p>
            ...
            {sent ? (
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label
                      ...
                      className="block text-xs font-mono text-gray-700 uppercase tracking-widest mb-2"
                    >
                      Nombre *
                    </label>
                    <input
                ...
                <div>
                  <label
                    htmlFor="contacto-tipo-de-consulta"
                    className="block text-xs font-mono text-gray-700 uppercase tracking-widest mb-2"
                  >
                    Tipo de consulta *
                  </label>
                  <select
                    id="contacto-tipo-de-consulta"
                    required
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-28">
            <div className="bg-paja border border-gray-300 rounded-sm p-8 mb-6">
              <div className="text-xs font-mono text-gray-600 uppercase tracking-widest mb-5">
                Por qué elegirnos
              </div>
