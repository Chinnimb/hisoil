      ...
      <div className="max-w-[1600px] mx-auto w-full">
        ...
        <div className="mb-4">
          <p className="text-xs font-mono text-gray-600 uppercase tracking-widest mb-4">
            Empresas que confían en Hisoil
          </p>
        ...
        {/* Alianzas strip */}
        <div>
          <p className="text-xs font-mono text-gray-600 uppercase tracking-widest mb-4 mt-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {alianzas.map((a, i) => (
              <div
                key={i}
                className="card-gradient-border p-5 flex flex-col items-center gap-3 hover:border-gray-400 transition-colors"
              >
        ...
        <div className="mt-10 flex flex-wrap gap-2 justify-center">
          {[
            ...
            <span
              key={s}
              className="bg-white border border-gray-300 text-gray-600 text-xs font-mono px-3 py-1.5 rounded-full"
            >
              {s}
            </span>
          ))}
