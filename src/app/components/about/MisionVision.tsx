        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-oliva rounded-sm p-10 md:p-14 relative overflow-hidden flex flex-col">
            ...
            <div className="relative z-10 flex flex-col flex-1">
              ...
              {/* Big quote mark */}
              <div className="text-white/5 font-serif text-[120px] leading-none select-none -mt-4 mb-2">
                "
              </div>

              <h2 className="text-white mb-6">Nuestra misión</h2>
              <p className="text-white/70 leading-relaxed text-lg flex-1">
                [Misión — Generar valor real y medible para nuestros clientes a través de productos
                técnicos y servicios ambientales que transformen residuos en recursos, mejoren
                suelos y contribuyan a un sistema productivo más eficiente y sostenible.]
              </p>
              ...
              <div className="mt-10 pt-8 border-t border-white/10 grid grid-cols-3 gap-4">
                {['Impacto real', 'Sostenibilidad', 'Valor medible'].map((v) => (
                  <div key={v} className="text-center">
                    ...
                    <div className="text-white/65 text-xs font-mono">{v}</div>
                  </div>
                ))}
              </div>
            </div>
          ...
          {/* Visión — light */}
          <div className="bg-paja border border-gray-300 rounded-sm p-10 md:p-14 flex flex-col relative overflow-hidden">
            <div
            ...
            <div className="relative z-10 flex flex-col flex-1">
              ...
              <div className="text-gray-100 font-serif text-[120px] leading-none select-none -mt-4 mb-2">
                "
              </div>

              <h2 className="text-oliva mb-6">Nuestra visión</h2>
              <p className="text-gray-700 leading-relaxed text-lg flex-1">
                [Visión — Ser la empresa de referencia en soluciones agro-ambientales en
                Latinoamérica, reconocida por la innovación de sus productos, la solidez de su
                equipo técnico y su contribución concreta a la transición hacia una economía
                circular en el sector agropecuario e industrial.]
              </p>

              <div className="mt-10 pt-8 border-t border-gray-300 grid grid-cols-3 gap-4">
                {['Innovación', 'Liderazgo', 'Futuro'].map((v) => (
                  <div key={v} className="text-center">
                    ...
                    <div className="text-gray-600 text-xs font-mono">{v}</div>
                  </div>
                ))}
              </div>
            </div>
