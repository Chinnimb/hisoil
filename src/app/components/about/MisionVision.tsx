          ...
          <div className="bg-oliva rounded-sm p-10 md:p-14 relative overflow-hidden flex flex-col">
            ...
            <div className="relative z-10 flex flex-col flex-1">
              <div className="inline-block border border-white/20 px-3 py-1 mb-8 self-start">
                <span className="text-white/65 text-xs font-mono uppercase tracking-widest">03 — Misión</span>
              </div>
          ...
          <div className="bg-paja border border-gray-300 rounded-sm p-10 md:p-14 flex flex-col relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col flex-1">
              <div className="inline-block border border-gray-300 px-3 py-1 mb-8 self-start">
                <span className="text-gray-600 text-xs font-mono uppercase tracking-widest">04 — Visión</span>
              </div>
