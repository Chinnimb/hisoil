      ...
      <div className="max-w-[1600px] mx-auto w-full">
        ...
        <div className="mb-16 max-w-2xl">
          <div className="inline-block border border-gray-300 px-3 py-1 mb-6">
            <span className="text-gray-700 text-xs font-mono uppercase tracking-widest">
              05 — Clientes y resultados
            </span>
          </div>
          <h2 className="text-oliva mb-4">Empresas que confían en Hisoil</h2>
          <p className="text-gray-700 leading-relaxed">
            [Descripción breve de la base de clientes, sectores atendidos y tipo de proyectos
            realizados.]
          </p>
        </div>
        ...
        <div className="border border-gray-300 bg-white rounded-sm p-8 md:p-12 mb-20">
          ...
          <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-px bg-gray-200">
            {logos.map((logo) => (
              <div key={logo.id} className="bg-white aspect-[3/2] flex items-center justify-center">
