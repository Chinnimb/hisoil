      ...
      <div className="max-w-[1600px] mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-start">
          ...
          <div className="relative order-2 lg:order-1">
            ...
            {/* Floating stat card */}
            <div className="absolute -bottom-6 left-6 bg-white border border-gray-300 px-6 py-4 rounded-sm shadow-sm">
              <div className="text-2xl font-bold text-oliva">+15 años</div>
              <div className="text-gray-700 text-xs font-mono mt-0.5">transformando el agro</div>
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2 pt-4 lg:pt-0">
            <div className="inline-block border border-gray-300 px-3 py-1 mb-6">
              <span className="text-gray-600 text-xs font-mono uppercase tracking-widest">02 — Quiénes somos</span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {kpis.map((k) => (
                <div key={k.label} className="bg-white border border-gray-300 p-5 rounded-sm">
