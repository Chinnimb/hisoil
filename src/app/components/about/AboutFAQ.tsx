        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="text-gray-700 leading-relaxed mb-8">
              [Texto de apoyo — Invitación a revisar las preguntas más comunes sobre la empresa,
              servicios y proceso de trabajo.]
            </p>
            <p className="text-gray-600 text-sm leading-relaxed">¿No encontrás lo que buscás?</p>
            ...
            <div className="divide-y divide-gray-200 border-y border-gray-200">
              {faqs.map((faq, i) => (
                <div key={i} className="py-0">
                  ...
                  >
                    <span
                      className={`font-medium transition-colors ${openIndex === i ? 'text-oliva' : 'text-gray-600 group-hover:text-oliva'}`}
                    >
                      {faq.question}
                    </span>
                    <div
                      className={`flex-shrink-0 w-7 h-7 border border-gray-300 rounded-full flex items-center justify-center transition-all ${openIndex === i ? 'bg-oliva border-gray-900' : 'group-hover:border-gray-500'}`}
                    >
                      <ChevronDown
                        size={14}
