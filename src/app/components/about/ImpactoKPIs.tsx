      ...
      <div className="max-w-[1600px] mx-auto w-full">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-16">
          <div className="max-w-xl">
            <div className="inline-block border border-gray-300 px-3 py-1 mb-6">
              <span className="text-gray-600 text-xs font-mono uppercase tracking-widest">07 — Impacto y sustentabilidad</span>
            </div>
              ...
              <div className="grid grid-cols-2 gap-px bg-paja">
                {group.items.map((item) => (
                  <div key={item.label} className="bg-white px-7 py-7">
                    <div className="text-3xl font-bold text-oliva mb-2 leading-none">{item.value}</div>
        ...
        <div className="mt-8 bg-paja border border-gray-300 rounded-sm px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div>
            ...
            <p className="text-gray-700 text-sm mt-1">[Texto — Diagnóstico inicial sin costo. Te mostramos cómo Hisoil puede generar resultados medibles en tu caso.]</p>
          </div>
