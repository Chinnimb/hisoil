        ...
        <div className="bg-oliva rounded-sm p-12 md:p-20 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/70 max-w-xl mx-auto mb-12 leading-relaxed">
              Diagnóstico inicial sin costo. El equipo técnico de HISOIL analiza tu operación
              y propone una solución a medida en menos de 48 horas.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-14">
              <button onClick={open} className="bg-white text-oliva px-10 py-4 rounded-full font-medium hover:bg-paja transition-colors">
