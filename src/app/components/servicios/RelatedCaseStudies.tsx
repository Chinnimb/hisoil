    ...
    <section className="py-16 md:py-24 lg:py-32 px-6 md:px-12 lg:px-20 bg-white">
      <div className="max-w-[1600px] mx-auto w-full">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-16">
          <div>
            <div className="inline-block border border-gray-300 px-3 py-1 mb-6">
              <span className="text-gray-700 text-xs font-mono uppercase tracking-widest">09 — Casos de estudio</span>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {cases.map((c) => (
            <div key={c.number} className="border border-gray-300 rounded-sm overflow-hidden flex flex-col">
              {/* Header */}
              <div className="bg-paja border-b border-gray-300 px-6 py-5">
                ...
                <div className="text-xs text-gray-600 font-mono mt-0.5">{c.sector}</div>
              </div>

              {/* Body */}
              <div className="p-6 flex-1 space-y-4">
                <div>
                  <div className="text-xs font-mono text-gray-600 uppercase tracking-widest mb-1">Desafío</div>
