        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="text-gray-700 leading-relaxed text-sm mb-8">
              [Texto — Respuestas a las consultas más comunes sobre los servicios de tratamiento de
              residuos y el portafolio de productos para cultivos.]
            </p>
            <p className="text-gray-600 text-sm mb-3">¿No encontrás tu respuesta?</p>
            ...
            <div className="divide-y divide-gray-200 border-y border-gray-200">
              {faqs.map((faq, i) => (
                <div key={i}>
                  ...
                  >
                    <span
                      className={`font-medium text-sm transition-colors ${openIndex === i ? 'text-oliva' : 'text-gray-600 group-hover:text-oliva'}`}
                    >
                      {faq.question}
                    </span>
                    <div
                      className={`flex-shrink-0 w-7 h-7 border rounded-full flex items-center justify-center transition-all ${openIndex === i ? 'bg-oliva border-gray-900' : 'border-gray-300 group-hover:border-gray-500'}`}
                    >
                      <ChevronDown
                        size={13}
                  ...
                  >
                    <p className="text-gray-700 text-sm leading-relaxed pr-10">{faq.answer}</p>
                  </div>
                </div>
              ))}
            </div>
