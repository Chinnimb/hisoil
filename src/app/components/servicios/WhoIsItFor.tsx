      ...
      <div className="max-w-[1600px] mx-auto w-full">
        ...
        <div className="mb-16 max-w-2xl">
          ...
          <p className="text-gray-700 leading-relaxed">
            [Descripción — Sectores y perfiles de clientes que más se benefician de los servicios de
            tratamiento y gestión ambiental de Hisoil.]
          </p>
        </div>
          ...
          {audiences.map((a) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-gray-700 text-sm leading-relaxed flex-1 mb-6">{a.description}</p>
        ...
        <div className="mt-12 card-gradient-border px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div>
            ...
            <p className="text-gray-700 text-sm mt-1">
              [Texto — Invitación a consultar independientemente del sector.]
            </p>
          </div>
