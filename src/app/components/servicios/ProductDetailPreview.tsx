        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                ...
                <>
                  ...
                  <div className="flex gap-2">
                    {imgs.map((src, i) => (
                      <div
                        key={i}
                        className={`flex-1 aspect-square rounded-sm overflow-hidden border-2 ${i === 0 ? 'border-gray-500' : 'border-gray-200'}`}
                      >
                        <img
                          src={src}
                          alt={`Vista ${i + 1}`}
          ...
          <div className="lg:col-span-8">
            <div className="flex items-center gap-3 mb-4">
              <span className="bg-oliva text-white text-xs font-mono px-3 py-1 rounded-full">
                Fertilizante
              </span>
              <span className="bg-paja text-gray-700 text-xs font-mono px-3 py-1 rounded-full">
                Soja · Maíz · Trigo
              </span>
            </div>
            ...
            <p className="text-gray-600 font-mono text-sm mb-6">
              SKU: HIS-[XXX-000] · Registro SENASA: [Nº]
            </p>

            <p className="text-gray-700 leading-relaxed mb-8">
              [Descripción técnica del producto — qué es, para qué sirve, en qué cultivos aplica y
              cuál es su mecanismo de acción principal. Destacar diferenciación respecto a productos
              convencionales.]
            </p>

            {/* Specs table */}
            <div className="mb-8">
              <h4 className="text-xs font-mono text-gray-600 uppercase tracking-widest mb-4">
