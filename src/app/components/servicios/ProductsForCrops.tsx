            ...
            <button
              ...
              className={`p-5 rounded-sm border text-left transition-all ${
                activeCategory === cat.id
                  ...
                  : "bg-paja/30 border-gray-200 text-gray-600 hover:border-gray-400"
              }`}
            >
            ...
            >
              ...
              <div className="p-5 flex-1 flex flex-col">
                ...
                <div className="flex items-center justify-between">
                  <button className="text-gray-500 text-xs border border-gray-300 px-3 py-1.5 rounded-full hover:bg-paja/30 transition-colors">
                    Ver detalle
                  </button>
                  <button className="text-gray-700 text-xs font-medium border border-gray-700 px-3 py-1.5 rounded-full hover:bg-paja/40 transition-colors">
                    Solicitar info
                  </button>
                </div>
              </div>
