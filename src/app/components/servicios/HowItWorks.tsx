...
const steps = [
  ...
  },
  {
    ...
    detail:
      'Camiones habilitados · Manifiestos de transporte · Coordinación logística · Trazabilidad documental',
  },
  {
    number: '03',
    ...
    detail:
      'Control de calidad · Mezcla de materiales · Compostaje controlado · Monitoreo de temperatura y humedad',
  },
  {
    number: '04',
    title: 'Valorización',
  ...
  },
  {
    ...
    detail:
      'Certificado de tratamiento · Certificado de disposición final · Reportes ambientales · Información para indicadores ESG',
  },
];
      ...
      <div className="max-w-[1600px] mx-auto w-full">
        ...
        <div className="mb-16 max-w-2xl">
          ...
          <p className="text-gray-700 leading-relaxed">
            Nuestro proceso integra logística, tratamiento y seguimiento técnico para garantizar una
            gestión segura, eficiente y completamente trazable.
          </p>
        </div>
            ...
            <div className="col-span-2 flex flex-col items-center">
              <div className="w-16 h-16 bg-oliva/10 backdrop-blur-md border border-oliva/20 rounded-xl flex items-center justify-center mb-3 hover:bg-lima/25 hover:border-lima/40 transition-all duration-500">
                {(() => {
                  ...
                  return <Icon className="w-7 h-7 text-oliva" />;
                })()}
              </div>
