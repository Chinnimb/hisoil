...
const timeline = [
  {
    ...
    phase: 'Diagnóstico',
    weeks: 'Semanas 1–2',
    desc: '[Auditoría de efluentes, muestreo y análisis fisicoquímico. Identificación de incumplimientos y riesgos regulatorios.]',
  },
  {
    step: '02',
    phase: 'Propuesta técnica',
    weeks: 'Semanas 3–4',
    desc: '[Diseño del sistema de tratamiento, selección de tecnología y presupuesto detallado con alternativas.]',
  },
  {
    step: '03',
    phase: 'Implementación',
    weeks: 'Semanas 5–20',
    desc: '[Instalación de planta modular, puesta en marcha y ajuste de parámetros operativos con supervisión diaria.]',
  },
  {
    step: '04',
    phase: 'Certificación',
    weeks: 'Semanas 21–24',
    desc: '[Muestreos de verificación, presentación ante organismo regulador y obtención de certificado de aptitud ambiental.]',
  },
  {
    step: '05',
    phase: 'Seguimiento',
    weeks: 'Mes 6 en adelante',
    desc: '[Monitoreo mensual, reportes automáticos y ajuste de proceso según variaciones estacionales de carga.]',
  },
];
      ...
      <div className="max-w-[1600px] mx-auto w-full">
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 mb-16">
          <div className="max-w-2xl">
            ...
            <h2 className="text-white mb-4">
              Tratamiento de efluentes para empresa frigorífica de exportación
            </h2>
            <div className="flex flex-wrap gap-3">
              <span className="bg-white/10 border border-white/20 text-white/70 text-xs font-mono px-3 py-1.5 rounded-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center">
            <div className="text-xs font-mono text-white/25 uppercase tracking-widest mb-4 flex items-center gap-3">
              <div className="w-6 h-6 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-white/65 text-xs">
                !
              </div>
              El problema
            </div>
            <h3 className="text-white text-xl font-semibold mb-5">
              Efluentes con carga orgánica 8× por encima del límite normativo, riesgo de clausura y
              pérdida de habilitación para exportar.
            </h3>
            <p className="text-white/45 leading-relaxed text-sm mb-6">
              [Descripción detallada del problema — situación inicial del cliente, historial de
              incumplimientos, presión del organismo regulador, impacto en su cadena de exportación
              y urgencia operativa.]
            </p>
            <div className="space-y-3">
              {[
                'Alta carga de DBO y sólidos suspendidos en efluentes',
                'Notificación de infracción de autoridad ambiental',
                'Riesgo de suspensión del certificado de exportación',
                'Ausencia de sistema de tratamiento previo',
              ].map((item) => (
        ...
        <div className="bg-white/5 border border-white/10 rounded-sm p-8 md:p-10 mb-8">
          ...
          <h3 className="text-white text-xl font-semibold mb-4">
            Sistema de tratamiento biológico modular en 3 etapas, diseñado e implementado por Hisoil
            en 20 semanas.
          </h3>
          <p className="text-white/45 leading-relaxed mb-10">
            [Descripción de la solución — diseño del sistema, tecnología utilizada, etapas de
            implementación, productos aplicados y metodología de seguimiento.]
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-white/10">
            {metrics.map((m) => (
              <div key={m.label} className="bg-oliva p-7 md:p-8">
                ...
                <div className="text-white/60 font-medium text-sm mb-1 leading-tight">
                  {m.label}
                </div>
