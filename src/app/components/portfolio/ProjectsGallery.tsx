...
const projects = [
  {
    id: 1,
    title: 'Recuperación de suelos degradados en zona pampeana',
    category: 'Agricultura',
    client: 'Pool de siembra — 4.800 ha',
    year: '2024',
    result: '+22% MO en suelo',
    size: 'large',
  },
  {
    id: 2,
    title: 'Planta de compostaje para residuos agroindustriales',
    category: 'Compostaje',
  ...
  {
    id: 3,
    title: 'Tratamiento de efluentes industriales fuera de norma',
    category: 'Tratamiento de residuos',
    client: 'Empresa textil — Santa Fe',
    year: '2023',
    result: '100% norma',
    size: 'medium',
  },
  {
    id: 4,
    title: 'Plan nutricional campaña soja/maíz 2023/24',
    category: 'Agricultura',
    client: 'Cooperativa Agropecuaria',
    year: '2024',
    result: '+18 qq/ha',
    size: 'medium',
  },
  {
    id: 5,
    title: 'Remediación pasivo ambiental ex-relleno sanitario',
    category: 'Municipios',
  ...
  {
    id: 6,
    title: 'Tratamiento de efluentes para planta láctea',
    category: 'Industria',
    client: 'Empresa láctea — Córdoba',
    year: '2024',
  ...
  {
    id: 7,
    title: 'Compostaje a escala para cadena de supermercados',
    category: 'Compostaje',
    client: 'Jumbo — Red de sucursales',
    year: '2023',
    result: '1.200 tn/año',
    size: 'medium',
  },
  {
    id: 8,
    title: 'Bioestimulación en horticultura intensiva bajo cubierta',
    category: 'Agricultura',
    client: 'Empresa hortícola — 85 ha',
    year: '2024',
    result: '−42% mortalidad',
    size: 'medium',
  },
  {
    id: 9,
    title: 'Plan de gestión ambiental empresarial ISO 14001',
    category: 'Empresas',
    client: 'Empresa industrial — Bs.As.',
    year: '2023',
    result: 'Certificación',
    size: 'medium',
  },
];
    ...
    <section className="py-20 md:py-28 px-6 bg-white">
      <div className="max-w-[1600px] mx-auto w-full">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8">
          ...
          <span className="text-gray-600 text-sm font-mono">{filtered.length} casos</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          {filtered.map((p, i) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-full ${isLarge ? 'aspect-[4/3] lg:aspect-auto lg:h-full lg:min-h-[560px]' : 'aspect-[4/3]'} relative overflow-hidden bg-oliva`}
                >
                  <img
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 md:p-6">
                    ...
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-white/55 text-xs font-mono">{p.year}</span>
                    </div>

                    {/* Title */}
                    <h3
                      className={`text-white font-semibold leading-snug mb-2 ${isLarge ? 'text-xl md:text-2xl' : 'text-base'}`}
                    >
                      {p.title}
                    </h3>

                    {/* Client */}
                    <p className="text-white/65 text-xs font-mono mb-4">{p.client}</p>
        ...
        <div className="mt-10 text-center">
          <button className="border border-gray-300 text-gray-600 px-8 py-3.5 rounded-full text-sm font-medium hover:bg-paja transition-colors whitespace-nowrap">
