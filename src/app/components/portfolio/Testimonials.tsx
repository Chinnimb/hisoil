const testimonials = [
  {
    quote:
      '[Testimonio — Descripción de la experiencia de trabajo con Hisoil, destacando el profesionalismo del equipo técnico, la rapidez de respuesta y el impacto real en la operación del cliente.]',
  ...
  {
    quote:
      '[Testimonio — Descripción de cómo Hisoil ayudó a mejorar el rendimiento del cultivo con una recomendación técnica precisa y el acompañamiento durante toda la campaña.]',
    name: 'Nombre Apellido',
  ...
  {
    quote:
      '[Testimonio — Descripción del valor del asesoramiento ambiental de Hisoil para el municipio, especialmente en la gestión ante el organismo regulador y la comunicación con la comunidad.]',
    name: 'Nombre Apellido',
  ...
  {
    quote:
      '[Testimonio — Descripción de los beneficios del programa de compostaje implementado por Hisoil para la cadena de supermercados, reducción de residuos y cumplimiento de objetivos de sustentabilidad.]',
    name: 'Nombre Apellido',
      ...
      <div className="max-w-[1600px] mx-auto w-full">
        ...
        <div className="mb-16">
          ...
          <p className="text-gray-700 leading-relaxed max-w-xl">
            [Descripción — Testimonios de clientes reales que documentaron su experiencia y los
            resultados obtenidos en sus proyectos.]
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {testimonials.map((t, i) => (
            ...
            >
              {/* Quote mark */}
              <div className="text-gray-100 font-serif text-7xl leading-none mb-2 select-none absolute top-6 right-7">
                "
              </div>
