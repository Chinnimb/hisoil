...
const steps: Step[] = [
    ...
    render: () => (
      <div className="space-y-5 text-gray-700 leading-relaxed">
        <p className="text-base md:text-lg">
          En Hisoil entendemos que el verdadero valor de una gestión ambiental no se mide únicamente
          por la cantidad de residuos tratados, sino por el{' '}
          <span className="text-oliva font-semibold">
            impacto positivo que genera sobre el clima, los suelos y la economía circular
          </span>
          .
        </p>
        <p>
          Desde hace más de dos décadas desarrollamos soluciones para el tratamiento biológico de
          residuos orgánicos provenientes de industrias, municipios y actividades agropecuarias,
          evitando que estos materiales sean enviados a disposición final.
        </p>
        <div className="bg-paja/50 border-l-4 border-lima rounded-r-xl px-5 py-4 mt-4">
          <p className="text-oliva font-semibold text-base md:text-lg leading-snug">
            Hoy ese trabajo evoluciona:{' '}
            <span className="text-lima">la generación de créditos de carbono certificados</span>.
          </p>
          <p className="text-gray-700 text-sm mt-2">
            Cada tonelada recuperada se convierte en un beneficio ambiental cuantificable,
  ...
  },
  {
    ...
    render: () => (
      <div className="space-y-5 text-gray-700 leading-relaxed">
        <p className="text-base md:text-lg">
          La generación de créditos de carbono comienza mucho antes de emitir un certificado.
          Requiere{' '}
          <span className="text-oliva font-semibold">
            medir, modelar, monitorear y demostrar científicamente
          </span>{' '}
          el impacto.
        </p>
        <p>
          En 2021 y 2022 desarrollamos dos{' '}
          <span className="text-oliva font-semibold">
            Inventarios Corporativos de Gases de Efecto Invernadero
          </span>{' '}
          bajo la metodología <span className="text-oliva font-semibold">GHG Protocol</span>,
          contemplando emisiones de Alcance 1, 2 y 3.
        </p>
        <p>
          Durante la medición 2022 se relevaron más de{' '}
          <span className="text-oliva font-semibold">44.400 t</span> de residuos orgánicos, con una
          huella de <span className="text-oliva font-semibold">4.168 tCO₂e</span> — una intensidad
          de <span className="text-lima font-bold">94 kg CO₂e por tonelada tratada</span>.
        </p>
      </div>
    ),
  },
    ...
    render: () => (
      <div className="space-y-5 text-gray-700 leading-relaxed">
        <div className="bg-oliva text-white rounded-2xl p-6">
          <div className="text-lima text-[10px] font-mono uppercase tracking-widest mb-2">
            Nombre del proyecto
          </div>
        ...
        <p>
          Diseñado bajo la metodología{' '}
          <span className="text-oliva font-semibold">CDM AMS-III.F</span> —{' '}
          <em>Avoidance of Methane Emissions through Composting</em>, que cuantifica las emisiones
          evitadas cuando los residuos se tratan mediante compostaje aeróbico en lugar de rellenos
          sanitarios.
        </p>
        <p>
          Registrado en el{' '}
          <span className="text-oliva font-semibold">BioCarbon Standard – GHG Program</span>,
          habilitando monitoreo, verificación e inscripción de reducciones.
        </p>
      </div>
    ),
  },
  {
    ...
    render: () => (
      <div className="space-y-5 text-gray-700 leading-relaxed">
        <p className="text-base md:text-lg">
          Cada tonelada de residuo orgánico evitada representa una{' '}
          <span className="text-oliva font-semibold">
            reducción potencial de emisiones de metano
          </span>
          , gas con alto potencial de calentamiento global.
        </p>
          ...
          {projectScope.map((item, i) => (
            ...
            >
              <div className="w-6 h-6 rounded-full bg-oliva/10 border border-oliva/25 flex items-center justify-center flex-shrink-0 mt-0.5">
                <span className="text-oliva text-[10px] font-mono font-bold">
        ...
        <div className="bg-lima/10 border border-lima/40 rounded-xl p-5 flex items-start gap-3">
          ...
          <p className="text-gray-800 text-sm leading-relaxed">
            Todo el proyecto sigue criterios internacionales de{' '}
            <span className="text-oliva font-semibold">
      ...
      <div className="space-y-5 text-gray-700 leading-relaxed">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-oliva text-white rounded-2xl p-6">
            ...
            <div className="font-bold text-3xl md:text-4xl mb-1">
              36.951 <span className="text-base text-lima">tCO₂e/año</span>
            </div>
          ...
          <div className="bg-oliva text-white rounded-2xl p-6">
            ...
            <div className="font-bold text-3xl md:text-4xl mb-1">
              4.966 <span className="text-base text-lima">tCO₂e/año</span>
            </div>
            <p className="text-white/70 text-xs">Cuarto año de operación</p>
          </div>
        </div>
        <p>
          Las reducciones se mantienen mediante tratamiento continuo y{' '}
          <span className="text-oliva font-semibold">sin emisiones por fugas (Leakage = 0)</span>,
          conforme a AMS-III.F.
        </p>
      </div>
    ),
  },
  {
    ...
    render: () => (
      <div className="space-y-5 text-gray-700 leading-relaxed">
        <p className="text-base md:text-lg">
          La visión de Hisoil no se limita a evitar emisiones. Desarrollamos una{' '}
          <span className="text-oliva font-semibold">plataforma de soluciones climáticas</span> que
          integra diferentes proyectos ambientales.
        </p>
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          {platformSolutions.map((s) => {
            ...
            return (
              <div
                key={s.title}
                className="bg-white border border-oliva/15 hover:border-oliva/40 rounded-xl p-4 transition-all"
              >
        ...
        <div className="bg-oliva text-white rounded-2xl p-6 md:p-7 mt-2">
          <p className="text-white leading-relaxed mb-3">
            Ofrecemos a empresas, industrias y productores la posibilidad de transformar sus{' '}
            <span className="text-lima font-semibold">
              pasivos ambientales en activos climáticos
            </span>
            .
          </p>
          <p className="text-white/80 text-sm leading-relaxed">
            Créditos de carbono de alta integridad, respaldados por ciencia, monitoreo y estándares
            internacionales.
          </p>
        </div>
      </div>
          ...
          <div className="max-w-[1600px] mx-auto w-full">
            ...
            >
              ...
              <p className="text-white/85 leading-relaxed text-lg max-w-2xl">
                Transformamos residuos en soluciones climáticas verificables bajo estándares
                internacionales.
              </p>
            </div>
      ...
      <div className="relative -mt-16 md:-mt-20 px-6 md:px-12 lg:px-20 pb-16 md:pb-24 lg:pb-32">
        <div className="max-w-[1600px] mx-auto w-full">
          ...
          >
                    ...
                    >
                      <div
                        className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 transition-all ${
                          isActive ? 'bg-oliva text-lima' : 'bg-oliva/10 text-oliva/60'
                        }`}
                      >
                      ...
                      <div className="text-left min-w-0">
                        <div
                          className={`text-[10px] font-mono uppercase tracking-widest ${isActive ? 'text-lima' : 'text-oliva/45'}`}
                        >
                          {s.step}
                        </div>
                        <div
                          className={`font-semibold text-sm leading-tight truncate ${isActive ? 'text-oliva' : 'text-oliva/70'}`}
                        >
                          {s.title}
                        </div>
                      </div>
            ...
            <div
              key={active.id}
              className="animate-in fade-in duration-500 grid grid-cols-1 lg:grid-cols-12 gap-0"
            >
