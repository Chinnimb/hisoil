      ...
      <div className="max-w-[1600px] mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 border border-gray-200 rounded-sm overflow-hidden">
          ...
          <div className="lg:col-span-7 bg-gray-950 p-12 md:p-16 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="inline-block border border-white/20 px-3 py-1 mb-8">
                <span className="text-white/40 text-xs font-mono uppercase tracking-widest">11 — ¿Querés resultados similares?</span>
              </div>
          ...
          <div className="lg:col-span-5 bg-white p-12 md:p-16 flex flex-col justify-center gap-4">
            <button className="bg-gray-900 text-white py-4 px-8 rounded-full font-semibold hover:bg-gray-800 transition-colors w-full whitespace-nowrap">
              Solicitar presupuesto
            </button>
            <button className="border border-gray-300 text-gray-700 py-4 px-8 rounded-full font-medium hover:bg-gray-50 transition-colors w-full flex items-center justify-center gap-3 whitespace-nowrap">
