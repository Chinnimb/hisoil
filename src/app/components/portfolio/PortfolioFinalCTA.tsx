      ...
      <div className="max-w-[1600px] mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 border border-gray-300 rounded-sm overflow-hidden">
          ...
          <div className="lg:col-span-7 bg-oliva p-12 md:p-16 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="inline-block border border-white/20 px-3 py-1 mb-8">
                <span className="text-white/65 text-xs font-mono uppercase tracking-widest">11 — ¿Querés resultados similares?</span>
              </div>
          ...
          <div className="lg:col-span-5 bg-white p-12 md:p-16 flex flex-col justify-center gap-4">
            <button className="bg-oliva text-white py-4 px-8 rounded-full font-semibold hover:bg-oliva transition-colors w-full whitespace-nowrap">
              Solicitar presupuesto
            </button>
            <button className="border border-gray-300 text-gray-700 py-4 px-8 rounded-full font-medium hover:bg-paja transition-colors w-full flex items-center justify-center gap-3 whitespace-nowrap">
              <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current text-gray-700 flex-shrink-0" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="pt-6 border-t border-gray-300 space-y-3">
              {["Diagnóstico inicial sin costo", "Respuesta en menos de 24 hs", "Sin compromisos en la primera consulta"].map((f) => (
