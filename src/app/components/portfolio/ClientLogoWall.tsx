      ...
      <div className="max-w-[1600px] mx-auto w-full">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-xl mx-auto leading-relaxed text-sm">
            [Descripción — Empresas líderes, productores y organismos públicos que eligieron a
            Hisoil como socio técnico en sus proyectos.]
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-px bg-gray-200 border border-gray-200">
          {clients.map((c) => (
            ...
            >
              ...
              <span className="text-gray-500 text-[9px] font-mono text-center leading-tight">
                {c.name}
              </span>
            </div>
          ))}
