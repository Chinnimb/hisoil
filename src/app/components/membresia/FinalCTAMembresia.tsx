      ...
      <div className="max-w-[1600px] mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 border border-gray-200 rounded-sm overflow-hidden">
          ...
          <div className="lg:col-span-7 bg-oliva p-12 md:p-16 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="inline-block border border-white/20 px-3 py-1 mb-8">
                <span className="text-white/40 text-xs font-mono uppercase tracking-widest">10 — Sumate</span>
              </div>
              <h2 className="text-white mb-6">Sumate a la comunidad Hisoil.</h2>
              <p className="text-white/50 leading-relaxed text-lg mb-10 max-w-lg">
                [Texto — Más de 500 productores y empresas ya confían en la Membresía Hisoil para planificar sus insumos, mejorar sus resultados y tener un equipo técnico siempre disponible.]
              </p>
          ...
          <div className="lg:col-span-5 bg-white p-12 md:p-16 flex flex-col justify-center gap-4">
            <div className="mb-2">
              <div className="text-oliva font-semibold text-lg mb-1">Empezá hoy.</div>
              <div className="text-gray-400 text-sm font-mono">
                El primer mes incluye asesoramiento de bienvenida sin cargo.
              </div>
            </div>

            <button className="bg-oliva text-white py-4 px-8 rounded-full font-semibold hover:bg-oliva transition-colors w-full">
              Elegir mi plan
            </button>
            <button className="border border-gray-300 text-gray-700 py-4 px-8 rounded-full font-medium hover:bg-paja/30 transition-colors w-full flex items-center justify-center gap-3">
              <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current text-gray-400 flex-shrink-0" xmlns="http://www.w3.org/2000/svg">
