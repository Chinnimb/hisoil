        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 border border-gray-300 rounded-sm overflow-hidden">
          ...
          <div className="lg:col-span-7 bg-oliva p-12 md:p-16 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/70 leading-relaxed text-lg mb-10 max-w-lg">
                [Texto — Más de 500 productores y empresas ya confían en la Membresía Hisoil para
                planificar sus insumos, mejorar sus resultados y tener un equipo técnico siempre
                disponible.]
              </p>
          ...
          <div className="lg:col-span-5 bg-white p-12 md:p-16 flex flex-col justify-center gap-4">
            ...
            <button className="border border-gray-300 text-gray-700 py-4 px-8 rounded-full font-medium hover:bg-paja transition-colors w-full flex items-center justify-center gap-3">
              <svg
                viewBox="0 0 24 24"
                className="w-4 h-4 fill-current text-gray-600 flex-shrink-0"
