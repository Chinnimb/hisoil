const pillars = [
  {
    ...
    description:
      '[Descripción — Elegís el plan que mejor se adapta a tu operación y podés ajustarlo en cualquier momento según la campaña o el ciclo productivo.]',
  },
  {
    number: '02',
    title: 'Productos programados',
    description:
      '[Descripción — Recibís los productos que necesitás en el momento exacto, sin tener que hacer pedidos individuales cada vez. Planificá con anticipación.]',
  },
  {
    number: '03',
    title: 'Asesoramiento continuo',
    description:
      '[Descripción — Accedés a nuestro equipo técnico de forma prioritaria para consultas, ajustes de dosis, recomendaciones de manejo y seguimiento de resultados.]',
  },
  {
    number: '04',
    title: 'Beneficios acumulativos',
    description:
      '[Descripción — Cuanto más tiempo sos miembro, mayores son los descuentos y beneficios que acumulás. El programa premia la fidelidad y la continuidad.]',
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-5">
            ...
            <h2 className="text-oliva mb-6">
              Un programa diseñado para clientes que operan en serio.
            </h2>
            <p className="text-gray-700 leading-relaxed mb-6">
              [Párrafo 1 — La Membresía Hisoil es un programa de suscripción anual para productores,
              empresas y profesionales agropecuarios que quieren acceso continuo a productos,
              técnicos y recursos.]
            </p>
            <p className="text-gray-700 leading-relaxed mb-10">
              [Párrafo 2 — No es solo un descuento: es un sistema de trabajo colaborativo donde
              Hisoil acompaña cada etapa del proceso productivo, desde la planificación hasta el
            ...
            <div className="border-l-4 border-gray-900 pl-6 py-2">
              <p className="text-gray-700 italic leading-relaxed">
                "[Cita destacada — El cliente miembro tiene un equipo técnico propio sin pagar el
                costo de tenerlo en planta.]"
              </p>
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-px bg-gray-200 border border-gray-200">
            {pillars.map((p) => (
              <div key={p.number} className="bg-white p-8 hover:bg-paja transition-colors">
                <div className="text-gray-100 font-mono font-bold text-5xl leading-none mb-5">
                  {p.number}
                </div>
