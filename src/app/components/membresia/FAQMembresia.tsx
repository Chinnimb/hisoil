      ...
      <div className="max-w-[1600px] mx-auto w-full">
        ...
        <div className="mb-12">
          <div className="inline-block border border-gray-300 px-3 py-1 mb-6">
            <span className="text-gray-600 text-xs font-mono uppercase tracking-widest">09 — Preguntas frecuentes</span>
          </div>
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
            <h2 className="text-oliva">Preguntas frecuentes sobre la membresía.</h2>
            <p className="text-gray-600 text-sm font-mono">¿No encontrás tu respuesta? Escribinos.</p>
          </div>
        </div>
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4 p-6 card-gradient-border">
          <div>
            ...
            <div className="text-gray-600 text-sm font-mono">El equipo de membresías responde en menos de 24 horas.</div>
          </div>
