...
export function FichaClienteForm() {
            ...
            {sent ? (
              <div className="bg-white border border-oliva/20 rounded-2xl p-10 md:p-14 text-center">
                ...
                <p className="text-gray-700 leading-relaxed max-w-md mx-auto">
                  Gracias por registrarte. Nuestro equipo se pondrá en contacto en las próximas 24 a 48 horas hábiles
                  para armar tu cotización.
                </p>
              </div>
            ) : (
              <form
