        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-5">
            <div className="inline-block border border-gray-300 px-3 py-1 mb-8">
              <span className="text-gray-600 text-xs font-mono uppercase tracking-widest">Sobre Hisoil</span>
            </div>
            ...
            <div className="flex flex-wrap gap-2 mb-10">
              {certs.map((c) => (
                <div key={c} className="border border-gray-300 rounded-sm px-4 py-2 flex items-center gap-2">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="text-xs font-mono text-gray-600 uppercase tracking-widest mb-6">Trayectoria</div>
                ...
                <div key={m.year} className="flex gap-6 group">
                  ...
                  <div className="flex flex-col items-center">
                    <div className="w-10 h-10 rounded-full border-2 border-gray-300 bg-white flex items-center justify-center flex-shrink-0 group-hover:border-gray-900 transition-colors z-10">
                      <span className="text-[10px] font-mono text-gray-600 group-hover:text-oliva transition-colors">{m.year.slice(2)}</span>
                    </div>
