        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="text-gray-700 leading-relaxed mb-6">
              Nacimos con la visión de cerrar el ciclo de nutrientes en el agro: convertir residuos
              en insumos, mejorar suelos sin química agresiva y acompañar a productores con técnicos
              que saben lo que hacen.
            </p>
            <p className="text-gray-700 leading-relaxed mb-10">
              Hoy operamos en 12 provincias con más de 800 clientes activos, un equipo de agrónomos
              especializados y una línea de productos propios certificados por SENASA e INTA.
            </p>
            ...
            <div className="flex flex-wrap gap-2 mb-10">
              {certs.map((c) => (
                <div
                  key={c}
                  className="border border-gray-300 rounded-sm px-4 py-2 flex items-center gap-2"
                >
                  <div className="w-4 h-4 bg-paja border border-gray-300 rounded-sm flex items-center justify-center">
                    <span className="text-gray-600 text-[7px] font-mono">✓</span>
                  </div>
            ...
            <Link to="/nosotros">
              <button className="border border-gray-300 text-gray-700 px-6 py-3 rounded-full text-sm font-medium hover:bg-paja transition-colors">
                Conocer la empresa →
              </button>
            </Link>
          </div>
          ...
          <div className="lg:col-span-7">
            ...
            <div className="relative w-full h-52 mb-10 overflow-hidden rounded-sm">
              ...
              <div className="absolute bottom-4 left-4 text-gray-700 text-xs font-mono">
                Operaciones en campo · Argentina
              </div>
            </div>
            <div className="text-xs font-mono text-gray-600 uppercase tracking-widest mb-6">
              Trayectoria
            </div>
              ...
              {milestones.map((m, i) => (
                <div key={m.year} className="flex gap-6 group">
                  ...
                  <div className="flex flex-col items-center">
                    <div className="w-10 h-10 rounded-full border-2 border-gray-300 bg-white flex items-center justify-center flex-shrink-0 group-hover:border-gray-900 transition-colors z-10">
                      <span className="text-[10px] font-mono text-gray-600 group-hover:text-oliva transition-colors">
                        {m.year.slice(2)}
                      </span>
                    </div>
                    {i < milestones.length - 1 && (
                      <div className="w-px flex-1 bg-gray-200 my-1" style={{ minHeight: 32 }} />
                    )}
                  </div>
                  ...
                  <div className="pb-8 pt-2 flex-1">
                    ...
                    <div className="text-gray-700 text-sm">{m.label}</div>
                  </div>
                </div>
              ))}
            </div>
            ...
            {/* Bottom stat row */}
            <div className="grid grid-cols-3 gap-px bg-gray-200 border border-gray-300 mt-8">
              {[
