...
const productsByTab: Record<
  string,
  { name: string; category: string; description: string; specs: string[] }[]
> = {
  'Más vendidos': [
    {
      name: '[Producto bestseller 01]',
      category: 'Fertilizante',
      description: '[Descripción breve del producto y principal beneficio para el cultivo.]',
      specs: ['NPK 20-10-10', '20L', 'Soja/Maíz'],
    },
    {
      name: '[Producto bestseller 02]',
      category: 'Bioestimulante',
      description: '[Descripción breve del producto y principal beneficio para el cultivo.]',
      specs: ['Aminoácidos', '1L', 'Universal'],
    },
    {
      name: '[Producto bestseller 03]',
      category: 'Compost',
      description: '[Descripción breve del producto y principal beneficio para el cultivo.]',
      specs: ['MO > 40%', '25kg', 'Universal'],
    },
    {
      name: '[Producto bestseller 04]',
      category: 'Enmienda',
      description: '[Descripción breve del producto y principal beneficio para el cultivo.]',
      specs: ['CaCO₃ 85%', '1000kg', 'Trigo/Soja'],
    },
    {
      name: '[Producto bestseller 05]',
      category: 'Nutrición',
      description: '[Descripción breve del producto y principal beneficio para el cultivo.]',
      specs: ['Fe, Zn, Mn', '5L', 'Multicultura'],
    },
    {
      name: '[Producto bestseller 06]',
      category: 'Bioestimulante',
      description: '[Descripción breve del producto y principal beneficio para el cultivo.]',
      specs: ['Bacillus sp.', '500ml', 'Horticultura'],
    },
  ],
  'Nuevos ingresos': [
    {
      name: '[Nuevo producto 01]',
      category: 'Tratamiento',
      description: '[Descripción breve del producto nuevo y principal beneficio para el cultivo.]',
      specs: ['Inoculante', '250ml', 'Soja'],
    },
    {
      name: '[Nuevo producto 02]',
      category: 'Fertilizante',
      description: '[Descripción breve del producto nuevo y principal beneficio para el cultivo.]',
      specs: ['Foliar', '10L', 'Maíz/Trigo'],
    },
    {
      name: '[Nuevo producto 03]',
      category: 'Compost',
      description: '[Descripción breve del producto nuevo y principal beneficio para el cultivo.]',
      specs: ['MO > 50%', '500kg', 'Universal'],
    },
    {
      name: '[Nuevo producto 04]',
      category: 'Bioestimulante',
      description: '[Descripción breve del producto nuevo y principal beneficio para el cultivo.]',
      specs: ['Ácido Fúlvico', '1L', 'Frutales'],
    },
    {
      name: '[Nuevo producto 05]',
      category: 'Enmienda',
      description: '[Descripción breve del producto nuevo y principal beneficio para el cultivo.]',
      specs: ['Yeso Agrícola', '750kg', 'Universal'],
    },
    {
      name: '[Nuevo producto 06]',
      category: 'Nutrición',
      description: '[Descripción breve del producto nuevo y principal beneficio para el cultivo.]',
      specs: ['Micropack', '2L', 'Horticultura'],
    },
  ],
  Recomendados: [
    {
      ...
      category: 'Bioestimulante',
      description:
        '[Descripción del producto recomendado por equipo técnico de Hisoil para la campaña actual.]',
      specs: ['Rizobio', '200ml', 'Soja'],
    },
    {
      name: '[Recomendado 02]',
      category: 'Fertilizante',
    ...
    },
    {
      ...
      description:
        '[Descripción del producto recomendado por equipo técnico de Hisoil para la campaña actual.]',
      specs: ['Trichoderma', '100g', 'Horticultura'],
    },
    {
      name: '[Recomendado 05]',
      category: 'Enmienda',
            ...
            {tabs.map((tab) => (
              <button
                ...
                className={`px-5 py-2 rounded-full text-sm font-medium transition-all ${
                  activeTab === tab ? 'bg-oliva text-white' : 'text-gray-700 hover:text-gray-700'
                }`}
              >
                {tab}
              </button>
