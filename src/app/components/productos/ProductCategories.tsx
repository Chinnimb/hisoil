const categories = [
  {
    ...
    count: 14,
    description:
      '[Fertilizantes de síntesis y biológicos para nutrición balanceada. Formulaciones líquidas y sólidas para distintas etapas del cultivo.]',
  ...
  },
  {
    ...
    count: 11,
    description:
      '[Estimulantes de crecimiento radicular, floración y resistencia al estrés. Elaborados con extractos naturales y microorganismos benéficos.]',
    tag: 'Rendimiento',
  ...
  },
  {
    ...
    count: 8,
    description:
      '[Compost certificado de alta calidad a partir de residuos orgánicos tratados. Mejora estructura, aireación y actividad biológica del suelo.]',
  ...
  },
  {
    ...
    count: 7,
    description:
      '[Correctores de pH, calcáreo agrícola y yeso agrícola. Ajuste y estabilización de condiciones fisicoquímicas del suelo a largo plazo.]',
  ...
  },
  {
    ...
    count: 12,
    description:
      '[Planes nutricionales completos formulados por cultivo. Combinaciones de macro y microelementos para cubrir requerimientos específicos.]',
    tag: 'Planes a medida',
  ...
  },
  {
    ...
    count: 9,
    description:
      '[Inoculantes, biofungicidas y bacterias fijadoras de nitrógeno. Soluciones biológicas para recuperación y regeneración del suelo productivo.]',
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14">
          <div className="max-w-xl">
            ...
            <p className="text-gray-700 leading-relaxed">
              [Descripción — Seis líneas de productos formuladas con respaldo técnico para cada
              necesidad agronómica.]
            </p>
          </div>
