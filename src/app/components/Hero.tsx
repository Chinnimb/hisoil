  ...
  return (
    <>
      ...
      <section className="relative min-h-[95vh] flex flex-col overflow-hidden">
        ...
        {/* Breadcrumb strip */}
        <div className="relative z-10 border-b border-white/10 px-6 md:px-12 lg:px-16 py-4">
        ...
        {/* Main content */}
        <div className="relative z-10 flex-1 flex flex-col max-w-[1600px] mx-auto w-full px-6 md:px-12 lg:px-16 pt-10 pb-10 md:pt-14 md:pb-14">
