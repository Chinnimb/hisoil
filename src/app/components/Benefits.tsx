      ...
      <div className="max-w-[1600px] mx-auto w-full">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end">
            ...
            <p className="text-white/65 lg:col-span-6 leading-relaxed">
              Estos resultados no son de laboratorio. Son del campo de clientes reales, medidos en
              campaña y documentados por nuestro equipo técnico.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-px bg-white/10 border border-white/10 mb-16">
          {stats.map((s) => (
            <div key={s.label} className="bg-oliva p-8 md:p-10">
              <div className="text-white font-bold text-4xl md:text-5xl mb-2 leading-none">
                {s.value}
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {pillars.map((p, i) => (
            <div
              key={p.title}
              className="border border-white/10 bg-white/[0.02] relative overflow-hidden"
            >
              {/* Image top half */}
