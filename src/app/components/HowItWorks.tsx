const steps = [
  {
    ...
    title: 'Diagnóstico',
    description:
      'Visitamos tu campo y realizamos un análisis completo de suelos y necesidades. Sin cargo, sin compromiso.',
  ...
  },
  {
    ...
    title: 'Propuesta',
    description:
      'Diseñamos un plan personalizado con los productos y técnicas más adecuadas a tu operación.',
  ...
  },
  {
    ...
    description:
      'Aplicamos con seguimiento técnico en cada etapa. Registramos y ajustamos en tiempo real.',
      ...
      <div className="max-w-[1600px] mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16 items-end">
          ...
          <div className="lg:col-span-6">
            <p className="text-gray-700 leading-relaxed">
              Un proceso técnico y ordenado que garantiza que cada producto se aplique correctamente
              y que el cliente vea resultados medibles en cada campaña.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-gray-200 border border-gray-200">
          {steps.map((s) => (
            <div key={s.number} className="bg-white p-8 flex flex-col">
              <div className="text-gray-100 font-mono font-bold text-6xl leading-none mb-8">
                {s.number}
              </div>
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4 p-6 border border-gray-300 bg-white rounded-sm">
          <div className="text-gray-600 text-sm">
            El diagnóstico inicial es sin costo y sin compromiso. Coordina en menos de 24 hs.
          </div>
