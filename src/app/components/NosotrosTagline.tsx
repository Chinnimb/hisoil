      ...
      <div className="max-w-[1600px] mx-auto w-full">
        <div ref={ref} className={`scroll-reveal ${visible ? 'is-visible' : ''}`}>
          ...
          <p
            ...
            style={{ fontSize: 'clamp(1.5rem, 2.4vw, 2.25rem)', letterSpacing: '-0.01em' }}
          >
            Más de 25 años transformando residuos orgánicos en recursos.
            <span className="text-gray-600 font-normal">
              {' '}
              Acompañamos a empresas, industrias, municipios y productores con soluciones de
              compostaje, sustratos y restauración ambiental que generan impacto real.
            </span>
          </p>
