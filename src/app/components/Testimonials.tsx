...
const testimonials = [
  {
    quote:
      'Trabajar con Hisoil transformó completamente nuestra operación. El acompañamiento técnico fue excelente y los resultados superaron nuestras expectativas. En solo una campaña vimos mejoras significativas en la calidad del suelo.',
    ...
    avatar:
      'https://images.unsplash.com/photo-1545830790-68595959c491?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmYXJtZXIlMjBwb3J0cmFpdCUyMHByb2Zlc3Npb25hbCUyMGFncmljdWx0dXJlfGVufDF8fHx8MTc4MDkzNTAzNnww&ixlib=rb-4.1.0&q=80&w=200',
  },
  {
    quote:
      'La solución de compostaje que implementamos nos permitió convertir un problema en una oportunidad. Ahora generamos nuestro propio fertilizante y reducimos costos operativos. El ROI fue evidente desde el primer año.',
    ...
    avatar:
      'https://images.unsplash.com/photo-1607746882042-944635dfe10e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3b21hbiUyMHNjaWVudGlzdCUyMHByb2Zlc3Npb25hbCUyMHBvcnRyYWl0fGVufDF8fHx8MTc4MDkzNTA0N3ww&ixlib=rb-4.1.0&q=80&w=200',
  },
  {
    quote:
      'El equipo de agrónomos de Hisoil nos brindó asesoramiento de primer nivel. Sus productos orgánicos son de excelente calidad y el servicio postventa es impecable. Los recomiendo sin dudas a cualquier productor.',
    ...
    avatar:
      'https://images.unsplash.com/photo-1627829382469-f4bce7df99ba?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwzfHxmYXJtZXIlMjBwb3J0cmFpdCUyMHByb2Zlc3Npb25hbCUyMGFncmljdWx0dXJlfGVufDF8fHx8MTc4MDkzNTAzNnww&ixlib=rb-4.1.0&q=80&w=200',
  },
];
      ...
      <div className="max-w-[1600px] mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 border border-white/10 rounded-sm overflow-hidden">
          ...
          <div className="lg:col-span-3 bg-white/5 border-b lg:border-b-0 lg:border-r border-white/10 p-8 flex flex-col justify-between">
            <div>
              <div className="text-white/55 text-xs font-mono uppercase tracking-widest mb-4">
          ...
          <div className="hidden lg:flex lg:col-span-2 flex-col gap-2 p-4 bg-white/[0.02] border-l border-white/10">
            {testimonials.map((tm, i) => (
              ...
              >
                ...
                <div
                  className={`text-sm font-bold ${i === current ? 'text-white' : 'text-white/55'}`}
                >
                  {tm.stat}
                </div>
              </button>
